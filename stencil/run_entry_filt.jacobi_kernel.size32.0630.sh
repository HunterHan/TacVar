...
cleanup_residual_processes(){
    local pattern='jacobi2d5p_.*\.x|jacobi2d5p_kernel_.*\.x|filt\.x|mpirun|prterun|orted|prted|run_entry_filt\.jacobi_kernel\.size32\.0630'
...
DATE_STAMP=${DATE_STAMP:-$(date +%Y%m%d-%H%M%S)-jacobi-kernel-size32-${INSITU_TAG}}
DATA_FOLDER="${DATA_ROOT}/${DATE_BASE}/${HOSTNAME}/output_jacobi_kernel_size32_0630_${INSITU_TAG}/${DATE_STAMP}"
