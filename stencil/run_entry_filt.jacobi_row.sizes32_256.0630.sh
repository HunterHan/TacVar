...
cleanup_residual_processes(){
    local pattern='jacobi2d5p_.*\.x|jacobi2d5p_kernel_.*\.x|filt\.x|mpirun|prterun|orted|prted|run_entry_filt\.jacobi_row\.sizes32_256\.0630'
...
DATE_STAMP=${DATE_STAMP:-$(date +%Y%m%d-%H%M%S)-jacobi-row-sizes32-256-${INSITU_TAG}}
DATA_FOLDER="${DATA_ROOT}/${DATE_BASE}/${HOSTNAME}/output_jacobi_row_sizes32_256_0630_${INSITU_TAG}/${DATE_STAMP}"
