...
mpicc -O2 -Wall -o ${kernel}_tsc_tf.x ./${kernel}_tf.c -DUSE_TF -DTIMING -DUSE_TSC -DNTEST=$nt -DNPASS=1 -lgsl -lopenblas
mpicc -O2 -Wall -o ${kernel}_cgt_tf.x ./${kernel}_tf.c -DUSE_TF -DTIMING -DUSE_CGT -DNTEST=$nt -DNPASS=1 -lgsl -lopenblas
mpicc -O2 -Wall -o ${kernel}_papi_tf.x ./${kernel}_tf.c -DUSE_TF -DTIMING -DUSE_PAPI -DNTEST=$nt -DNPASS=1 -lgsl -lopenblas -lpapi                               
mpicc -O2 -Wall -o ${kernel}_papix6_tf.x ./${kernel}_tf.c -DUSE_TF -DTIMING -DUSE_PAPIX6 -DNTEST=$nt -DNPASS=1 -lgsl -lopenblas -lpapi                           
mpicc -O2 -Wall -o ${kernel}_likwid_tf.x ./${kernel}_tf.c -DUSE_TF -DTIMING -DUSE_LIKWID -DLIKWID_PERFMON -DNTEST=$nt -DNPASS=1 -lgsl -lopenblas -llikwid
